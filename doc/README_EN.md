...
This part also can be done by a command (see this [MATLAB Answer](https://jp.mathworks.com/matlabcentral/answers/396348-how-to-find-and-replace-within-mlx-live-scripts-across-multiple-files)Åjbut it's a undocumented function. 
...
```matlab
% matlab code sample view (é¿çsÇ≥ÇÍÇ»Ç¢ÇÊÅj
x = linspace(0,1,100);
y = sin(x);
plot(x,y);
```
